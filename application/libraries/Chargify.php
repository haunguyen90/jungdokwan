...
class Chargify {
	protected $username 	= 'ni6kkv4qhgZ77CCP0dgW';		// Chargify API Key
	protected $domain 	= 'salesfollowup123';		// Chargify Subdomain
	...
	***************************************************************************************************************/
	...
	public function get_subscription_transactions($subscripton_id) {
		$result = $this->query('/subscriptions/'.$subscripton_id.'/transactions.json');
